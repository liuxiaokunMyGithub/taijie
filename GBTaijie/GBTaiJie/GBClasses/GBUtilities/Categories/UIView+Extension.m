...
+ (void)showHubWithTip:(NSString *)tip {
    [self showHubWithTip:tip timeintevel:1.5];
}
...
+ (void)showHubWithTip:(NSString *)tip timeintevel:(CGFloat)intever {
    ...
    hud.label.text = tip;
    hud.label.font = Fit_Font(14);
    hud.label.textColor = [UIColor whiteColor];
    hud.bezelView.style = MBProgressHUDBackgroundStyleSolidColor;
    hud.bezelView.backgroundColor = [UIColor kImportantTitleTextColor];
    hud.margin = 5.f;
    hud.bezelView.layer.cornerRadius = 2;
    
    hud.removeFromSuperViewOnHide = YES;
    [hud hideAnimated:YES afterDelay:intever];
}
