...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.userInteractionEnabled = !self.isForbidSelect;
    ...
    if ([self.selectedTags containsObject:self.tags[indexPath.item]]) {
        ...
        if (self.tagAttribute.selectBorderColor) {
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([self.selectedTags containsObject:self.tags[indexPath.item]]) {
        ...
        // 复原文本色
        if (self.coustomNormalTitleColors.count) {
            cell.backgroundColor = [self.coustomNormalTitleColors objectAtIndex:indexPath.row];
        }
