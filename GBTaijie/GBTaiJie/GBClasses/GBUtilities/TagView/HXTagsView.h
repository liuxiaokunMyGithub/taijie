...
@property (nonatomic,strong) NSArray <NSString *>*tags;//传入的标签数组 字符串数组
...
@property (nonatomic,assign) NSInteger minSelectCount;// 最少保留选中多少
@property (nonatomic,assign) NSInteger maxSelectCount;// 最多保留选中多少
/* <#describe#> */
@property (nonatomic, assign) CGFloat iconMargin;

@property (nonatomic,copy) NSString *key;//搜索关键词

@property (nonatomic,strong) NSMutableArray *coustomNormalBackgroundColors;// 自定义常规色
@property (nonatomic,strong) NSMutableArray *coustomSelectedBackgroundColors;//自定义选中色
@property (nonatomic,strong) NSMutableArray *coustomNormalTagIcons;//自定义常规图标
@property (nonatomic,strong) NSMutableArray *coustomSelectedTagIcons;//自定义选中图标
@property (nonatomic,strong) NSMutableArray *coustomNormalTitleColors;// 自定义常规色
@property (nonatomic,strong) NSMutableArray *coustomSelectedTitleColors;//自定义选中色
@property (nonatomic,strong) NSMutableArray *coustomIconBackGroundColors;//自定义图标背景色
