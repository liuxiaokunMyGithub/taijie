...
@property (nonatomic,assign) BOOL isForbidSelect;//是否禁止选择 默认:NO 

@property (nonatomic,copy) NSString *key;//搜索关键词

@property (nonatomic,strong) NSArray *coustomNormalBackgroundColors;// 自定义常规色
@property (nonatomic,strong) NSArray *coustomSelectedBackgroundColors;//自定义选中色
@property (nonatomic,strong) NSArray *coustomNormalTagIcons;//自定义常规图标
@property (nonatomic,strong) NSArray *coustomSelectedTagIcons;//自定义选中图标
@property (nonatomic,strong) NSArray *coustomNormalTitleColors;// 自定义常规色
@property (nonatomic,strong) NSArray *coustomSelectedTitleColors;//自定义选中色
